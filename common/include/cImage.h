	...
	*/
	...
	class _EXPORT_ cImage
	{
		...
		protected:
			...
			static bool PlatformGetDataFromFile( const char* szFile, unsigned char **pData, unsigned int *width, unsigned int *height, int absolute_path=0 );
			static void GetAsciiFromFile( unsigned char **pData, unsigned int *out_width, unsigned int *out_height );
			static void GetAsciiExtFromFile( unsigned char **pData, unsigned int *out_width, unsigned int *out_height );
