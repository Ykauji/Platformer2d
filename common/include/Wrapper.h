...
namespace AGK
{
	...
	class agk
	{
		...
		public:
			...
			// capabilities
			static int CanUseIntIndices() { return (m_iCapFlags & AGK_CAP_UINT_INDICES) ? 1 : 0; }
		...
		public:
			...
			static UINT GetSocketListnerConnection( UINT listenerID );
		    ...
		    static void Set3DPhysicsHingeJointMaxMotorImpluse( UINT jointID, float maxImpluse );
			...
			static void Set3DPhysicsTwistJointMaxMotorImpluse( UINT jointID, float maxImpluse );
			...
			static void Set3DPhysicsRadollBonesVisible( UINT objID, int isVisible );
