...
namespace AGK
{
	...
	class AGKVector
	{
		public:
			...
			void Interpolate( const AGKVector &from, const AGKVector &to, float t );
	...
	class AGKQuaternion
	{
		public:
			...
			float Dot( const AGKQuaternion &other );
	...
	class AGKMatrix3
	{
		public:
			...
			{ 
				return mat[0][0]==o[0] && mat[0][1]==o[1] && mat[0][2]==o[2] 
			        && mat[1][0]==o[3] && mat[1][1]==o[4] && mat[1][2]==o[5] 
					&& mat[2][0]==o[6] && mat[2][1]==o[7] && mat[2][2]==o[8];
			}
	};
	...
	class AGKMatrix4
	{
		public:
			...
			void MakeProj( float fFov, float fAspect, float fNear, float fFar, float fWidth, bool righthand=false );
