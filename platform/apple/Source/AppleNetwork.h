#ifndef _H_NETWORK_IOS
#define _H_NETWORK_IOS
...
namespace AGK
{
	...
	{
	protected:
		char m_Buffer[ AGK_NET_PACKET_SIZE ] __attribute__ ((aligned(4)));
		UINT m_iPtr;
	...
	protected:
		...
		char m_sendBuffer[ AGK_NET_SEND_BUFFER_SIZE ] __attribute__ ((aligned(4)));
