...
case AGKI_GETSOCKETLISTNERCONNECTION_L_L:
{
    int param0 = m_pStack[ --m_iStackPtr ].i;
    m_pStack[ m_iStackPtr++ ].i = agk::GetSocketListnerConnection( param0 );
    break;
}
...
case AGKI_SET3DPHYSICSHINGEJOINTMAXMOTORIMPLUSE_0_L_F:
{
    float param1 = m_pStack[ --m_iStackPtr ].f;
    int param0 = m_pStack[ --m_iStackPtr ].i;
    agk::Set3DPhysicsHingeJointMaxMotorImpluse( param0, param1 );
    break;
}
...
case AGKI_SET3DPHYSICSTWISTJOINTMAXMOTORIMPLUSE_0_L_F:
{
    float param1 = m_pStack[ --m_iStackPtr ].f;
    int param0 = m_pStack[ --m_iStackPtr ].i;
    agk::Set3DPhysicsTwistJointMaxMotorImpluse( param0, param1 );
    break;
}
...
case AGKI_SET3DPHYSICSRADOLLBONESVISIBLE_0_L_L:
{
    int param1 = m_pStack[ --m_iStackPtr ].i;
    int param0 = m_pStack[ --m_iStackPtr ].i;
    agk::Set3DPhysicsRadollBonesVisible( param0, param1 );
    break;
}
